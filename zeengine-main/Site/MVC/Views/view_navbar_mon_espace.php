    ...
    <header>
        <div class="menu-btn" id="menuBtn">
            ...
            <ul class="menu-options">
                ...
                <li><a href="?controller=mon_espace&action=mon_espace" class="Clients">Clients</a></li>
                <li><a href="?controller=mon_espace&action=prestataire" class="Prestataires">Prestataires</a></li>
                <li><a href="?controller=mon_espace&action=interlocuteur" class="Interlocuteurs">Interlocuteurs</a></li>
            </ul>
        </div>
        ...
        <nav>
				...
				<p class="MonEspace">Mon espace</p>
				<a href="?controller=mon_espace&action=mon_espace" class="boutonNav Clients">Clients</a>
                <a href="?controller=mon_espace&action=composante" class="boutonNav Composantes">Composantes</a>
                <a href="?controller=mon_espace&action=interlocuteur" class="boutonNav Interlocuteurs">Interlocuteurs</a>
				<a href="?controller=mon_espace&action=prestataire" class="boutonNav Prestataires">Prestataires</a>
                <a href="?controller=mon_espace&action=gestionnaire" class="boutonNav Gestionnaires">Gestionnaires</a>
        </nav>
        <nav class="navbar">
            <ul>
                <li>
