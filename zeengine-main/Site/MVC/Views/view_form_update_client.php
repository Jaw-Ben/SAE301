...
<body>
    ...
    <div class="form-container">
        ...
        <form action="?controller=set&action=modifier_client" method='post' class="profile-form">
            <div class="input-group">
            <h1>Modifier <?=$titre ?></h1> 
                <label for="nom">Nom :</label>
                <input type="text" id="nom" name="nom" value=<?= $ligneInfo['nomclient'];?> class="input-field">
            </div>
            <div class="input-group">
                <label for="prenom">Téléphone :</label>
                <input type="text" id="Tel" name="tel" value=<?= $ligneInfo['telclient'];?> class="input-field">
            </div>
            <div class="input-group">
